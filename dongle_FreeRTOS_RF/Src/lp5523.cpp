...
uint8_t led_PWM[9] = {0};
uint8_t led_current[9] = {10, 10, 10, 10, 10, 10, 10, 10, 10};

//void setup_LP5523(void){
//	uint8_t deviceAddress = LIS3DH_DEFAULT_ADDRESS << 1;
//
//	uint8_t packet;
//
//	// enable chip
...
////		osDelay(1000);
////		HAL_GPIO_TogglePin(LD1_GPIO_Port, LD1_Pin);
//		if(flip==0) led_PWM[index] += 10;
//		else led_PWM[index] -= 10;
//
...
//		HAL_I2C_Mem_Write_IT(I2C_HANDLE_TYPEDEF, deviceAddress, LIS3DH_D1_PWM_REG, 1, led_PWM, 9);
