...
// fixing some c++ conversion issues
#define uint8_t byte
...
/**
  ******************************************************************************
  * The below has been adapted from SparkFun's example code
  ******************************************************************************
  */

//The default I2C address for the BNO080 on the SparkX breakout is 0x4A. 0x4B is also possible.
...
{
public:
	//boolean begin(uint8_t deviceAddress = BNO080_DEFAULT_ADDRESS, I2C_HandleTypeDef &wirePort = &hi2c1, uint8_t intPin = 255); //By default use the default I2C addres, and use Wire port, and don't declare an INT pin
