...
const osMessageQueueAttr_t msgPasssingUSB_Queue_attributes = {
  .name = "msgPasssingUSB_Queue"
};
...
//    		  logReceivedMessage.status = Buf[0] - '0';
//    		  logReceivedMessage.logStatus = Buf[1] - '0';
