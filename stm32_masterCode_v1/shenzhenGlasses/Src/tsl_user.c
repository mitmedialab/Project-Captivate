...
/* 3CH_LIN_M1_B_NBR1 bank definition*/
...
*/
CONST uint16_t MyLinRotB0_DeltaCoeff[3] = {0x0100, 0x0100, 0x0100};

/* LinRots list (ROM)*/
CONST TSL_LinRotB_T MyLinRotsB[TSLPRM_TOTAL_LINROTS_B] =
{
   /* LinRotB sensor 0 = S1 */
   {
   &MyLinRots_Data[0],
   ...
   MyLinRotB0_DeltaCoeff,
   (TSL_tsignPosition_T *)TSL_POSOFF_3CH_LIN_M1,
   TSL_SCTCOMP_3CH_LIN_M1,
   TSL_POSCORR_3CH_LIN_M1,
   }
};
...
{
  { TSL_OBJ_LINEARB, (TSL_LinRotB_T *)&MyLinRotsB[0] }
};
