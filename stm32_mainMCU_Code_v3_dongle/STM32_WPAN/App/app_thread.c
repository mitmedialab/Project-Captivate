...
static otCoapResource OT_Border_Packet_Ressource = { C_BORER_PACKET_RESSOURCE, APP_THREAD_DummyReqHandler,
...
static void APP_THREAD_CoapBorderPacketRequestHandler(otCoapHeader *pHeader, otMessage *pMessage,
	...
	do {
		...
		BSP_LED_Toggle(LED_RED);
#endif
		if (otMessageRead(pMessage, otMessageGetOffset(pMessage), &receivedPacket, sizeof(struct LogPacket))
...
//				CDC_Transmit_FS(buffer, sizeof(buffer));
				...
				CDC_Transmit_FS(&receivedPacket, sizeof(struct LogPacket));
