 ...
 * @retval None
 */
void SVCCTL_RegisterSvcHandler(
		SVC_CTL_p_EvtHandler_t pfBLE_SVC_Service_Event_Handler) {
#if (BLE_CFG_SVC_MAX_NBR_CB > 0)
 ...
 * @retval None
 */
void SVCCTL_RegisterCltHandler(
		SVC_CTL_p_EvtHandler_t pfBLE_SVC_Client_Event_Handler) {
#if (BLE_CFG_CLT_MAX_NBR_CB > 0)
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_UserEvtRx(void *pckt) {
	...
	case EVT_VENDOR: {
		...
		case SVCCTL_GATT_EVT_TYPE:
			...
			for (index = 0; index < SVCCTL_EvtHandler.NbreOfRegisteredHandler;
					index++) {
			...
			event_notification_status = SVCCTL_EvtNotAck;
			for (index = 0; index < SVCCTL_CltHandler.NbreOfRegisteredHandler;
					index++) {
				event_notification_status =
