																										...
																										typedef PACKED(struct)
																										{
																											...
																											typedef PACKED(struct)
																											{
																												...
																												typedef PACKED(struct)
																												{
																														...
																														Host_Nb_Of_Completed_Pkt_Pair_t Host_Nb_Of_Completed_Pkt_Pair[(BLE_CMD_MAX_PARAM_LEN
																																- 1)
																																																																																																																									...
																																																																																																																									typedef PACKED(struct)
																																																																																																																									{
																																																																																																																										...
																																																																																																																										typedef PACKED(struct)
																																																																																																																										{
																																																																																																																											...
																																																																																																																											typedef PACKED(struct)
																																																																																																																											{
																																																																																																																													uint8_t Offset;
																																																																																																																													uint8_t Length;
																																																																																																																													uint8_t Value[BLE_CMD_MAX_PARAM_LEN
																																																																																																																															- 2];
																																																																																																																												...
																																																																																																																												typedef PACKED(struct)
																																																																																																																												{
																																																																																																																													...
																																																																																																																													typedef PACKED(struct)
																																																																																																																													{
																																																																																																																														...
																																																																																																																														typedef PACKED(struct)
																																																																																																																														{
																																																																																																																																uint8_t Status;
																																																																																																																																uint8_t Data_Length;
																																																																																																																																uint8_t Data[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																		- 3)
																																																																																																																																		- 2];
																																																																																																																																																						...
																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																						{
																																																																																																																																																							...
																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																							{
																																																																																																																																																								...
																																																																																																																																																								typedef PACKED(struct)
																																																																																																																																																								{
																																																																																																																																																										...
																																																																																																																																																										uint8_t Local_Name[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																												- 13];
																																																																																																																																																									...
																																																																																																																																																									typedef PACKED(struct)
																																																																																																																																																									{
																																																																																																																																																											...
																																																																																																																																																											uint8_t Service_Uuid_List[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																													- 13];
																																																																																																																																																																																	...
																																																																																																																																																																																	typedef PACKED(struct)
																																																																																																																																																																																	{
																																																																																																																																																																																		...
																																																																																																																																																																																		typedef PACKED(struct)
																																																																																																																																																																																		{
																																																																																																																																																																																			...
																																																																																																																																																																																			typedef PACKED(struct)
																																																																																																																																																																																			{
																																																																																																																																																																																				...
																																																																																																																																																																																				{
																																																																																																																																																																																						uint8_t AdvDataLen;
																																																																																																																																																																																						uint8_t AdvData[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																								- 1];
																																																																																																																																																																																																						...
																																																																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																																																																						{
																																																																																																																																																																																																							...
																																																																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																																																																							{
																																																																																																																																																																																																								...
																																																																																																																																																																																																								typedef PACKED(struct)
																																																																																																																																																																																																								{
																																																																																																																																																																																																										...
																																																																																																																																																																																																										Whitelist_Entry_t Whitelist_Entry[(BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																												- 18)
																																																																																																																																																																																																												/ sizeof(Whitelist_Entry_t)];
																																																																																																																																																																																																																						...
																																																																																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																																																																																						{
																																																																																																																																																																																																																							...
																																																																																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																																																																																							{
																																																																																																																																																																																																																								...
																																																																																																																																																																																																																								typedef PACKED(struct)
																																																																																																																																																																																																																								{
																																																																																																																																																																																																																										...
																																																																																																																																																																																																																										uint8_t Adv_Data[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																																												- 8];
																																																																																																																																																																																																																											...
																																																																																																																																																																																																																											typedef PACKED(struct)
																																																																																																																																																																																																																											{
																																																																																																																																																																																																																												...
																																																																																																																																																																																																																												typedef PACKED(struct)
																																																																																																																																																																																																																												{
																																																																																																																																																																																																																													...
																																																																																																																																																																																																																													typedef PACKED(struct)
																																																																																																																																																																																																																													{
																																																																																																																																																																																																																															...
																																																																																																																																																																																																																															Bonded_Device_Entry_t Bonded_Device_Entry[((BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																	- 3)
																																																																																																																																																																																																																																	- 2)
																																																																																																																																																																																																																																						...
																																																																																																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																																																																																																						{
																																																																																																																																																																																																																																							...
																																																																																																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																																																																																																							{
																																																																																																																																																																																																																																								...
																																																																																																																																																																																																																																								typedef PACKED(struct)
																																																																																																																																																																																																																																								{
																																																																																																																																																																																																																																										...
																																																																																																																																																																																																																																										Whitelist_Identity_Entry_t Whitelist_Identity_Entry[(BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																																																												- 2)
																																																																																																																																																																																																																																																					...
																																																																																																																																																																																																																																																					typedef PACKED(struct)
																																																																																																																																																																																																																																																					{
																																																																																																																																																																																																																																																						...
																																																																																																																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																																																																																																																						{
																																																																																																																																																																																																																																																							...
																																																																																																																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																																																																																																																							{
																																																																																																																																																																																																																																																									...
																																																																																																																																																																																																																																																									uint8_t Char_Desc_Value[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																																																																											- 12];
																																																																																																																																																																																																																																																								...
																																																																																																																																																																																																																																																								typedef PACKED(struct)
																																																																																																																																																																																																																																																								{
																																																																																																																																																																																																																																																									...
																																																																																																																																																																																																																																																									typedef PACKED(struct)
																																																																																																																																																																																																																																																									{
																																																																																																																																																																																																																																																										...
																																																																																																																																																																																																																																																										typedef PACKED(struct)
																																																																																																																																																																																																																																																										{
																																																																																																																																																																																																																																																												...
																																																																																																																																																																																																																																																												uint8_t Char_Value[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																																																																														- 6];
																																																																																																																																																																																																																																																																						...
																																																																																																																																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																																																																																																																																						{
																																																																																																																																																																																																																																																																							...
																																																																																																																																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																																																																																																																																							{
																																																																																																																																																																																																																																																																								...
																																																																																																																																																																																																																																																																								typedef PACKED(struct)
																																																																																																																																																																																																																																																																								{
																																																																																																																																																																																																																																																																										...
																																																																																																																																																																																																																																																																										uint8_t Attribute_Val[BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																												- 9];
																																																																																																																																																																																																																																																																																																		...
																																																																																																																																																																																																																																																																																																		typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																		{
																																																																																																																																																																																																																																																																																																			...
																																																																																																																																																																																																																																																																																																			typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																			{
																																																																																																																																																																																																																																																																																																				...
																																																																																																																																																																																																																																																																																																				typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																				{
																																																																																																																																																																																																																																																																																																						uint16_t Connection_Handle;
																																																																																																																																																																																																																																																																																																						uint8_t Number_of_Handles;
																																																																																																																																																																																																																																																																																																						Handle_Entry_t Handle_Entry[(BLE_CMD_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																								- 3)
																																																																																																																																																																																																																																																																																																								/ sizeof(Handle_Entry_t)];
																																																																																																																																																																																																																																																																																																																																	...
																																																																																																																																																																																																																																																																																																																																	typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																	{
																																																																																																																																																																																																																																																																																																																																		...
																																																																																																																																																																																																																																																																																																																																		typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																		{
																																																																																																																																																																																																																																																																																																																																			...
																																																																																																																																																																																																																																																																																																																																			typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																			{
																																																																																																																																																																																																																																																																																																																																					...
																																																																																																																																																																																																																																																																																																																																					uint8_t Value[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																							- 3)
																																																																																																																																																																																																																																																																																																																																							- 5];
																																																																																																																																																																																																																																																																																																																																															...
																																																																																																																																																																																																																																																																																																																																															typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																															{
																																																																																																																																																																																																																																																																																																																																																...
																																																																																																																																																																																																																																																																																																																																																typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																{
																																																																																																																																																																																																																																																																																																																																																	...
																																																																																																																																																																																																																																																																																																																																																	typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																	{
																																																																																																																																																																																																																																																																																																																																																		...
																																																																																																																																																																																																																																																																																																																																																		{
																																																																																																																																																																																																																																																																																																																																																				uint8_t Number_of_Handles;
																																																																																																																																																																																																																																																																																																																																																				Handle_Packets_Pair_Entry_t Handle_Packets_Pair_Entry[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																						- 1)
																																																																																																																																																																																																																																																																																																																																																			...
																																																																																																																																																																																																																																																																																																																																																			typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																			{
																																																																																																																																																																																																																																																																																																																																																				...
																																																																																																																																																																																																																																																																																																																																																				typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																				{
																																																																																																																																																																																																																																																																																																																																																					...
																																																																																																																																																																																																																																																																																																																																																					{
																																																																																																																																																																																																																																																																																																																																																							uint8_t Num_Reports;
																																																																																																																																																																																																																																																																																																																																																							Advertising_Report_t Advertising_Report[((BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																									- 1)
																																																																																																																																																																																																																																																																																																																																																									- 1)
																																																																																																																																																																																																																																																																																																																																																										...
																																																																																																																																																																																																																																																																																																																																																										typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																										{
																																																																																																																																																																																																																																																																																																																																																											...
																																																																																																																																																																																																																																																																																																																																																											typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																											{
																																																																																																																																																																																																																																																																																																																																																												...
																																																																																																																																																																																																																																																																																																																																																												typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																												{
																																																																																																																																																																																																																																																																																																																																																													...
																																																																																																																																																																																																																																																																																																																																																													{
																																																																																																																																																																																																																																																																																																																																																															uint8_t Num_Reports;
																																																																																																																																																																																																																																																																																																																																																															Direct_Advertising_Report_t Direct_Advertising_Report[((BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																	- 1)
																																																																																																																																																																																																																																																																																																																																																																	- 1)
																																																																																																																																																																																																																																																																																																																																																																											...
																																																																																																																																																																																																																																																																																																																																																																											typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																											{
																																																																																																																																																																																																																																																																																																																																																																												...
																																																																																																																																																																																																																																																																																																																																																																												typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																												{
																																																																																																																																																																																																																																																																																																																																																																													...
																																																																																																																																																																																																																																																																																																																																																																													typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																													{
																																																																																																																																																																																																																																																																																																																																																																															...
																																																																																																																																																																																																																																																																																																																																																																															uint8_t Attr_Data[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																	- 2)
																																																																																																																																																																																																																																																																																																																																																																																	- 8];
																																																																																																																																																																																																																																																																																																																																																																														...
																																																																																																																																																																																																																																																																																																																																																																														typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																														{
																																																																																																																																																																																																																																																																																																																																																																															...
																																																																																																																																																																																																																																																																																																																																																																															typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																															{
																																																																																																																																																																																																																																																																																																																																																																																...
																																																																																																																																																																																																																																																																																																																																																																																typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																{
																																																																																																																																																																																																																																																																																																																																																																																		...
																																																																																																																																																																																																																																																																																																																																																																																		uint8_t Handle_UUID_Pair[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																				- 2)
																																																																																																																																																																																																																																																																																																																																																																																				- 4];
																																																																																																																																																																																																																																																																																																																																																																																	...
																																																																																																																																																																																																																																																																																																																																																																																	typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																	{
																																																																																																																																																																																																																																																																																																																																																																																			...
																																																																																																																																																																																																																																																																																																																																																																																			Attribute_Group_Handle_Pair_t Attribute_Group_Handle_Pair[((BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																					- 2)
																																																																																																																																																																																																																																																																																																																																																																																					- 3)
																																																																																																																																																																																																																																																																																																																																																																																		...
																																																																																																																																																																																																																																																																																																																																																																																		typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																		{
																																																																																																																																																																																																																																																																																																																																																																																				...
																																																																																																																																																																																																																																																																																																																																																																																				uint8_t Data_Length;
																																																																																																																																																																																																																																																																																																																																																																																				uint8_t Handle_Value_Pair_Data[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																						- 2)
																																																																																																																																																																																																																																																																																																																																																																																						- 4];
																																																																																																																																																																																																																																																																																																																																																																																			...
																																																																																																																																																																																																																																																																																																																																																																																			typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																			{
																																																																																																																																																																																																																																																																																																																																																																																					uint16_t Connection_Handle;
																																																																																																																																																																																																																																																																																																																																																																																					uint8_t Event_Data_Length;
																																																																																																																																																																																																																																																																																																																																																																																					uint8_t Attribute_Value[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																							- 2)
																																																																																																																																																																																																																																																																																																																																																																																							- 3];
																																																																																																																																																																																																																																																																																																																																																																																				...
																																																																																																																																																																																																																																																																																																																																																																																				typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																				{
																																																																																																																																																																																																																																																																																																																																																																																					...
																																																																																																																																																																																																																																																																																																																																																																																					typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																					{
																																																																																																																																																																																																																																																																																																																																																																																							uint16_t Connection_Handle;
																																																																																																																																																																																																																																																																																																																																																																																							uint8_t Event_Data_Length;
																																																																																																																																																																																																																																																																																																																																																																																							uint8_t Set_Of_Values[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																									- 2)
																																																																																																																																																																																																																																																																																																																																																																																									- 3];
																																																																																																																																																																																																																																																																																																																																																																																						...
																																																																																																																																																																																																																																																																																																																																																																																						typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																						{
																																																																																																																																																																																																																																																																																																																																																																																								...
																																																																																																																																																																																																																																																																																																																																																																																								uint8_t Data_Length;
																																																																																																																																																																																																																																																																																																																																																																																								uint8_t Attribute_Data_List[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																										- 2)
																																																																																																																																																																																																																																																																																																																																																																																										- 4];
																																																																																																																																																																																																																																																																																																																																																																																							...
																																																																																																																																																																																																																																																																																																																																																																																							typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																							{
																																																																																																																																																																																																																																																																																																																																																																																									...
																																																																																																																																																																																																																																																																																																																																																																																									uint8_t Part_Attribute_Value[(BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																											- 2)
																																																																																																																																																																																																																																																																																																																																																																																											- 7];
																																																																																																																																																																																																																																																																																																																																																																																														...
																																																																																																																																																																																																																																																																																																																																																																																														typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																														{
																																																																																																																																																																																																																																																																																																																																																																																															...
																																																																																																																																																																																																																																																																																																																																																																																															typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																															{
																																																																																																																																																																																																																																																																																																																																																																																																...
																																																																																																																																																																																																																																																																																																																																																																																																typedef PACKED(struct)
																																																																																																																																																																																																																																																																																																																																																																																																{
																																																																																																																																																																																																																																																																																																																																																																																																		uint16_t Connection_Handle;
																																																																																																																																																																																																																																																																																																																																																																																																		uint8_t Number_of_Handles;
																																																																																																																																																																																																																																																																																																																																																																																																		Handle_Item_t Handle_Item[((BLE_EVT_MAX_PARAM_LEN
																																																																																																																																																																																																																																																																																																																																																																																																				- 2)
																																																																																																																																																																																																																																																																																																																																																																																																				- 3)
																																																																																																																																																																																																																																																																																																																																																																																																				/ sizeof(Handle_Item_t)];
