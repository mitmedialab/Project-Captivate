...
static void hci_read_remote_version_information_complete_event_process(
		const uint8_t *in);
...
static void hci_le_read_remote_features_complete_event_process(
		const uint8_t *in);
...
static void hci_le_read_local_p256_public_key_complete_event_process(
		const uint8_t *in);
...
static void aci_gatt_disc_read_char_by_uuid_resp_event_process(
		const uint8_t *in);
...
const hci_event_table_t hci_event_table[HCI_EVENT_TABLE_SIZE] = { { 0x0005U,
		hci_disconnection_complete_event_process }, { 0x0008U,
		hci_encryption_change_event_process }, { 0x000CU,
		hci_read_remote_version_information_complete_event_process }, { 0x0010U,
		hci_hardware_error_event_process }, { 0x0013U,
		hci_number_of_completed_packets_event_process }, { 0x0030U,
		hci_encryption_key_refresh_complete_event_process }, };

/* HCI LE event process functions table */
const hci_event_table_t hci_le_event_table[HCI_LE_EVENT_TABLE_SIZE] = { {
		0x0001U, hci_le_connection_complete_event_process }, { 0x0002U,
		hci_le_advertising_report_event_process }, { 0x0003U,
		hci_le_connection_update_complete_event_process }, { 0x0004U,
		hci_le_read_remote_features_complete_event_process }, { 0x0005U,
		hci_le_long_term_key_request_event_process }, { 0x0007U,
		hci_le_data_length_change_event_process }, { 0x0008U,
		hci_le_read_local_p256_public_key_complete_event_process }, { 0x0009U,
		hci_le_generate_dhkey_complete_event_process }, { 0x000AU,
		hci_le_enhanced_connection_complete_event_process }, { 0x000BU,
		hci_le_direct_advertising_report_event_process }, { 0x000CU,
		hci_le_phy_update_complete_event_process }, };

/* HCI VS event process functions table */
const hci_event_table_t hci_vs_event_table[HCI_VS_EVENT_TABLE_SIZE] = { {
		0x0004U, aci_hal_end_of_radio_activity_event_process }, { 0x0005U,
		aci_hal_scan_req_report_event_process }, { 0x0006U,
		aci_hal_fw_error_event_process }, { 0x0400U,
		aci_gap_limited_discoverable_event_process }, { 0x0401U,
		aci_gap_pairing_complete_event_process }, { 0x0402U,
		aci_gap_pass_key_req_event_process }, { 0x0403U,
		aci_gap_authorization_req_event_process }, { 0x0404U,
		aci_gap_slave_security_initiated_event_process }, { 0x0405U,
		aci_gap_bond_lost_event_process }, { 0x0407U,
		aci_gap_proc_complete_event_process }, { 0x0408U,
		aci_gap_addr_not_resolved_event_process }, { 0x0409U,
		aci_gap_numeric_comparison_value_event_process }, { 0x040AU,
		aci_gap_keypress_notification_event_process }, { 0x0800U,
		aci_l2cap_connection_update_resp_event_process }, { 0x0801U,
		aci_l2cap_proc_timeout_event_process }, { 0x0802U,
		aci_l2cap_connection_update_req_event_process }, { 0x080AU,
		aci_l2cap_command_reject_event_process }, { 0x0C01U,
		aci_gatt_attribute_modified_event_process }, { 0x0C02U,
		aci_gatt_proc_timeout_event_process }, { 0x0C03U,
		aci_att_exchange_mtu_resp_event_process }, { 0x0C04U,
		aci_att_find_info_resp_event_process }, { 0x0C05U,
		aci_att_find_by_type_value_resp_event_process }, { 0x0C06U,
		aci_att_read_by_type_resp_event_process }, { 0x0C07U,
		aci_att_read_resp_event_process }, { 0x0C08U,
		aci_att_read_blob_resp_event_process }, { 0x0C09U,
		aci_att_read_multiple_resp_event_process }, { 0x0C0AU,
		aci_att_read_by_group_type_resp_event_process }, { 0x0C0CU,
		aci_att_prepare_write_resp_event_process }, { 0x0C0DU,
		aci_att_exec_write_resp_event_process }, { 0x0C0EU,
		aci_gatt_indication_event_process }, { 0x0C0FU,
		aci_gatt_notification_event_process }, { 0x0C10U,
		aci_gatt_proc_complete_event_process }, { 0x0C11U,
		aci_gatt_error_resp_event_process }, { 0x0C12U,
		aci_gatt_disc_read_char_by_uuid_resp_event_process }, { 0x0C13U,
		aci_gatt_write_permit_req_event_process }, { 0x0C14U,
		aci_gatt_read_permit_req_event_process }, { 0x0C15U,
		aci_gatt_read_multi_permit_req_event_process }, { 0x0C16U,
		aci_gatt_tx_pool_available_event_process }, { 0x0C17U,
		aci_gatt_server_confirmation_event_process }, { 0x0C18U,
		aci_gatt_prepare_write_permit_req_event_process }, { 0x0C1DU,
		aci_gatt_read_ext_event_process }, { 0x0C1EU,
		aci_gatt_indication_ext_event_process }, { 0x0C1FU,
		aci_gatt_notification_ext_event_process }, };
...
static void hci_read_remote_version_information_complete_event_process(
	...
	hci_read_remote_version_information_complete_event(rp0->Status,
			rp0->Connection_Handle, rp0->Version, rp0->Manufacturer_Name,
			rp0->Subversion);
}
...
static void hci_le_connection_complete_event_process(const uint8_t *in) {
	...
	hci_le_connection_complete_event(rp0->Status, rp0->Connection_Handle,
			rp0->Role, rp0->Peer_Address_Type, rp0->Peer_Address,
...
static void hci_le_connection_update_complete_event_process(const uint8_t *in) {
	...
	hci_le_connection_update_complete_event(rp0->Status, rp0->Connection_Handle,
			rp0->Conn_Interval, rp0->Conn_Latency, rp0->Supervision_Timeout);
}
...
static void hci_le_read_remote_features_complete_event_process(
	...
	hci_le_read_remote_features_complete_event(rp0->Status,
			rp0->Connection_Handle, rp0->LE_Features);
}
...
static void hci_le_long_term_key_request_event_process(const uint8_t *in) {
	...
	hci_le_long_term_key_request_event(rp0->Connection_Handle,
			rp0->Random_Number, rp0->Encrypted_Diversifier);
}
...
static void hci_le_data_length_change_event_process(const uint8_t *in) {
	...
	hci_le_data_length_change_event(rp0->Connection_Handle, rp0->MaxTxOctets,
			rp0->MaxTxTime, rp0->MaxRxOctets, rp0->MaxRxTime);
}
...
static void hci_le_enhanced_connection_complete_event_process(const uint8_t *in) {
	...
	hci_le_enhanced_connection_complete_event(rp0->Status,
			rp0->Connection_Handle, rp0->Role, rp0->Peer_Address_Type,
			rp0->Peer_Address, rp0->Local_Resolvable_Private_Address,
			rp0->Peer_Resolvable_Private_Address, rp0->Conn_Interval,
...
static void hci_le_phy_update_complete_event_process(const uint8_t *in) {
	...
	hci_le_phy_update_complete_event(rp0->Status, rp0->Connection_Handle,
			rp0->TX_PHY, rp0->RX_PHY);
}
...
static void aci_hal_end_of_radio_activity_event_process(const uint8_t *in) {
	...
	aci_hal_end_of_radio_activity_event(rp0->Last_State, rp0->Next_State,
...
static void aci_hal_scan_req_report_event_process(const uint8_t *in) {
	...
	aci_hal_scan_req_report_event(rp0->RSSI, rp0->Peer_Address_Type,
			rp0->Peer_Address);
}
...
static void aci_gap_pairing_complete_event_process(const uint8_t *in) {
	...
	aci_gap_pairing_complete_event(rp0->Connection_Handle, rp0->Status,
			rp0->Reason);
}
...
__WEAK void aci_gap_proc_complete_event(uint8_t Procedure_Code, uint8_t Status,
...
static void aci_gap_proc_complete_event_process(const uint8_t *in) {
	...
	aci_gap_proc_complete_event(rp0->Procedure_Code, rp0->Status,
...
static void aci_l2cap_proc_timeout_event_process(const uint8_t *in) {
	...
	aci_l2cap_proc_timeout_event(rp0->Connection_Handle, rp0->Data_Length,
			rp0->Data);
}
...
static void aci_l2cap_connection_update_req_event_process(const uint8_t *in) {
	...
	aci_l2cap_connection_update_req_event(rp0->Connection_Handle,
			rp0->Identifier, rp0->L2CAP_Length, rp0->Interval_Min,
			rp0->Interval_Max, rp0->Slave_Latency, rp0->Timeout_Multiplier);
}
...
static void aci_l2cap_command_reject_event_process(const uint8_t *in) {
	...
	aci_l2cap_command_reject_event(rp0->Connection_Handle, rp0->Identifier,
			rp0->Reason, rp0->Data_Length, rp0->Data);
}
...
static void aci_gatt_attribute_modified_event_process(const uint8_t *in) {
	...
	aci_gatt_attribute_modified_event(rp0->Connection_Handle, rp0->Attr_Handle,
			rp0->Offset, rp0->Attr_Data_Length, rp0->Attr_Data);
}
...
__WEAK void aci_att_find_info_resp_event(uint16_t Connection_Handle,
		uint8_t Format, uint8_t Event_Data_Length,
...
static void aci_att_find_info_resp_event_process(const uint8_t *in) {
	...
	aci_att_find_info_resp_event(rp0->Connection_Handle, rp0->Format,
			rp0->Event_Data_Length, rp0->Handle_UUID_Pair);
}
...
static void aci_att_find_by_type_value_resp_event_process(const uint8_t *in) {
	...
	aci_att_find_by_type_value_resp_event(rp0->Connection_Handle,
			rp0->Num_of_Handle_Pair, rp0->Attribute_Group_Handle_Pair);
}
...
static void aci_att_read_by_type_resp_event_process(const uint8_t *in) {
	...
	aci_att_read_by_type_resp_event(rp0->Connection_Handle,
			rp0->Handle_Value_Pair_Length, rp0->Data_Length,
...
static void aci_att_read_resp_event_process(const uint8_t *in) {
	...
	aci_att_read_resp_event(rp0->Connection_Handle, rp0->Event_Data_Length,
			rp0->Attribute_Value);
}
...
static void aci_att_read_multiple_resp_event_process(const uint8_t *in) {
	...
	aci_att_read_multiple_resp_event(rp0->Connection_Handle,
			rp0->Event_Data_Length, rp0->Set_Of_Values);
}
...
static void aci_att_read_by_group_type_resp_event_process(const uint8_t *in) {
	...
	aci_att_read_by_group_type_resp_event(rp0->Connection_Handle,
			rp0->Attribute_Data_Length, rp0->Data_Length,
...
static void aci_att_prepare_write_resp_event_process(const uint8_t *in) {
	...
	aci_att_prepare_write_resp_event(rp0->Connection_Handle,
			rp0->Attribute_Handle, rp0->Offset,
...
__WEAK void aci_gatt_error_resp_event(uint16_t Connection_Handle,
		uint8_t Req_Opcode, uint16_t Attribute_Handle, uint8_t Error_Code) {
}

/* ACI_GATT_ERROR_RESP_EVENT process function */
static void aci_gatt_error_resp_event_process(const uint8_t *in) {
	aci_gatt_error_resp_event_rp0 *rp0 = (void*) in;
	aci_gatt_error_resp_event(rp0->Connection_Handle, rp0->Req_Opcode,
			rp0->Attribute_Handle, rp0->Error_Code);
}

/* ACI_GATT_DISC_READ_CHAR_BY_UUID_RESP_EVENT callback function */
__WEAK void aci_gatt_disc_read_char_by_uuid_resp_event(
...
static void aci_gatt_disc_read_char_by_uuid_resp_event_process(
	...
	aci_gatt_disc_read_char_by_uuid_resp_event(rp0->Connection_Handle,
			rp0->Attribute_Handle, rp0->Attribute_Value_Length,
			rp0->Attribute_Value);
}
...
static void aci_gatt_write_permit_req_event_process(const uint8_t *in) {
	...
	aci_gatt_write_permit_req_event(rp0->Connection_Handle,
			rp0->Attribute_Handle, rp0->Data_Length, rp0->Data);
}
...
static void aci_gatt_read_multi_permit_req_event_process(const uint8_t *in) {
	...
	aci_gatt_read_multi_permit_req_event(rp0->Connection_Handle,
			rp0->Number_of_Handles, rp0->Handle_Item);
}
...
static void aci_gatt_prepare_write_permit_req_event_process(const uint8_t *in) {
	...
	aci_gatt_prepare_write_permit_req_event(rp0->Connection_Handle,
			rp0->Attribute_Handle, rp0->Offset, rp0->Data_Length, rp0->Data);
}
...
static void aci_gatt_read_ext_event_process(const uint8_t *in) {
	...
	aci_gatt_read_ext_event(rp0->Connection_Handle, rp0->Offset,
			rp0->Event_Data_Length, rp0->Attribute_Value);
}
...
static void aci_gatt_indication_ext_event_process(const uint8_t *in) {
	...
	aci_gatt_indication_ext_event(rp0->Connection_Handle, rp0->Attribute_Handle,
			rp0->Offset, rp0->Attribute_Value_Length, rp0->Attribute_Value);
}
...
static void aci_gatt_notification_ext_event_process(const uint8_t *in) {
	...
	aci_gatt_notification_ext_event(rp0->Connection_Handle,
			rp0->Attribute_Handle, rp0->Offset, rp0->Attribute_Value_Length,
			rp0->Attribute_Value);
}
