...
typedef struct {
	...
	MOBLE_RESULT (*WriteLocalData)(MODEL_MessageHeader_t *pmsgParams,
			MOBLEUINT8 offset, MOBLEUINT8 const *data, MOBLEUINT32 length,
			MOBLEBOOL response);
...
typedef struct {
	...
	MOBLE_RESULT (*ModelSIG_GetOpcodeTableCb)(
			const MODEL_OpcodeTableParam_t **data, MOBLEUINT16 *length);
	...
	MOBLE_RESULT (*ModelSIG_GetRequestCb)(MODEL_MessageHeader_t *pmsgParams,
			MOBLEUINT16 opcode, MOBLEUINT8 *data, MOBLEUINT32 *res_length,
			MOBLEUINT8 const *pData, MOBLEUINT32 length, MOBLEBOOL response);
	...
	MOBLE_RESULT (*ModelSIG_SetRequestCb)(MODEL_MessageHeader_t *pmsgParams,
			MOBLEUINT16 opcode, MOBLEUINT8 const *data, MOBLEUINT32 length,
			MOBLEBOOL response);
...
typedef struct {
	...
	MOBLE_RESULT (*ModelVendor_GetOpcodeTableCb)(
			const MODEL_OpcodeTableParam_t **data, MOBLEUINT16 *length);
...
MOBLE_RESULT BLEMesh_SetRemoteData(MOBLE_ADDRESS peer, MOBLEUINT8 elementIndex,
		MOBLEUINT16 command, MOBLEUINT8 const *data, MOBLEUINT32 length,
		MOBLEBOOL response, MOBLEUINT8 isVendor);
...
MOBLE_RESULT BLEMesh_SetRemotePublication(MOBLEUINT32 modelId,
		MOBLE_ADDRESS srcAddress, MOBLEUINT16 command, MOBLEUINT8 const *data,
		MOBLEUINT32 length, MOBLEBOOL response, MOBLEUINT8 isVendor);
...
MOBLE_RESULT BLEMesh_ModelSendMessage(MOBLE_ADDRESS srcAddress,
		MOBLE_ADDRESS peerAddress, MOBLEUINT32 modelId, MOBLEUINT16 opcode,
...
MOBLE_RESULT Vendor_WriteRemoteData(MOBLEUINT32 vendorModelId,
		MOBLE_ADDRESS src_addr, MOBLE_ADDRESS dst_peer, MOBLEUINT8 command,
		MOBLEUINT8 const *data, MOBLEUINT32 length, MOBLEBOOL response);
...
MOBLE_RESULT BLEMesh_SendResponse(MOBLE_ADDRESS peer, MOBLE_ADDRESS dst,
		MOBLEUINT8 status, MOBLEUINT8 const *data, MOBLEUINT32 length);
...
MOBLE_RESULT VendorModel_SendResponse(MOBLEUINT16 vendorModelId,
		MODEL_MessageHeader_t *pmsgParams, MOBLEUINT8 status,
...
MOBLE_RESULT ConfigModel_SendMessage(MOBLE_ADDRESS src_peer,
		MOBLE_ADDRESS dst_peer, MOBLEUINT16 opcode, MOBLEUINT8 *pData,
		MOBLEUINT32 length, MOBLEUINT8 *pTargetDevKey);
...
MOBLE_RESULT ConfigModel_SelfPublishConfig(MOBLE_ADDRESS dst_peer,
		MOBLEUINT16 opcode, MOBLEUINT8 *pData, MOBLEUINT32 length);
 ...
 * \return MOBLE_RESULT_SUCCESS on success, MOBLE_RESULT_FAIL if failure code.
 */
MOBLE_RESULT BLEMesh_BleConfigModelInitCallBack(
		MOBLE_CONFIG_MODEL_CB_MAP const *_cb);
 ...
 *
 */
MOBLE_RESULT BLEMesh_Get_PublicationParameters(
		model_publicationparams_t *pPublicationParams, MOBLEUINT8 elementIndex,
		MOBLEUINT32 modelId);
...
MOBLE_RESULT BLEMesh_GetSubscriptionAddress(MOBLE_ADDRESS *addressList,
		MOBLEUINT8 *sizeOfList, MOBLEUINT8 elementIndex, MOBLEUINT32 modelId);
...
MOBLE_RESULT BLEMesh_ModelsCheckSubscription(MOBLE_ADDRESS dst_peer,
		MOBLEUINT32 modelID, MOBLEUINT8 elementIndex);
...
void BLEMesh_CustomBeaconReceivedCallback(const MOBLEUINT8 *bdAddr,
		const MOBLEUINT8 *data, MOBLEUINT8 length, MOBLEINT8 rssi);
