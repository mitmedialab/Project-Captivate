...
MOBLE_RESULT PalNvmRead(MOBLEUINT32 address, MOBLEUINT32 offset, void *buf,
		MOBLEUINT32 size, MOBLEBOOL backup);
MOBLE_RESULT PalNvmBackupRead(MOBLEUINT32 address, void *buf, MOBLEUINT32 size);
MOBLE_RESULT PalNvmWrite(MOBLEUINT32 address, MOBLEUINT32 offset,
		void const *buf, MOBLEUINT32 size);
MOBLEBOOL PalNvmIsWriteProtected(void);
MOBLE_RESULT PalNvmCompare(MOBLEUINT32 address, MOBLEUINT32 offset,
		void const *buf, MOBLEUINT32 size, MOBLE_NVM_COMPARE *result);
MOBLE_RESULT PalNvmErase(MOBLEUINT32 address, MOBLEUINT32 offset);
